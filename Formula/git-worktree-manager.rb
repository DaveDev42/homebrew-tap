class GitWorktreeManager < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "54bd58c2579ae3a631bb548414a350ebcb2fbfb1704f12c0e1bae6f5f6f40f8e"
    else
      url "https://github.com/DaveDev42/git-worktree-manager/releases/download/v#{version}/gw-x86_64-apple-darwin.tar.gz"
      sha256 "59e645a0785412d7696344b2722f272baf1bf9ea6a65c6e94e418e283e44adf1"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "69f7b4ea4d5e1630be232f0b6997040210021c8b6388b147ab07e347fc3b9418"
    else
      url "https://github.com/DaveDev42/git-worktree-manager/releases/download/v#{version}/gw-x86_64-unknown-linux-musl.tar.gz"
      sha256 "9590a5fe6d9022020e47fe4a836ec78e453ac4f4805193348d34e8d5f0fd12c3"
    end
  end
